...
class ProfileWidget extends StatelessWidget {
  ...
  const ProfileWidget({super.key, required this.firstName, required this.secondName, required this.job, required this.description});
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            FilledButton.icon(onPressed: () {}, label: Text('Download'), icon: Icon(Icons.download_outlined), iconAlignment: IconAlignment.start),
            IconButton(onPressed: () {}, icon: FaIcon(FontAwesomeIcons.linkedinIn)),
            IconButton(onPressed: () {}, icon: FaIcon(FontAwesomeIcons.github)),
            IconButton(onPressed: () {}, icon: FaIcon(FontAwesomeIcons.at)),
